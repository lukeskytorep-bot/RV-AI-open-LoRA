"""
rv_lite_runner_delayed_label.py (v1.3-DL)
...
Delayed Label experimental session condition.
...
7. Blind Protocol: Random ID assignment, initial touches, dynamic data loops, and deep exploration.
8. Late Interpretation: Opens a separate interpretation phase before the target reveal.
9. Clean Reveal & Eval: Displays the actual target BEFORE the AI's evaluation.
10. Post-Session Exercises: Optionally runs sensory calibration exercises after the target reveal.
11. Seamless Automation & Loop: Runs multiple sessions and returns to the main menu.
"""
...
SESSION_VARIANT = "Delayed Label"

SESSION_CONDITION_PROMPT = """EXPERIMENTAL SESSION CONDITION: DELAYED LABEL
...
An entry in the Analytical-Overlay Register must not be treated as established, repeated as fact, or allowed to organize subsequent vectors.

This restriction remains active until the Monitor explicitly writes:
...
BLIND_PHASE_REMINDER = (
    "The delayed-label condition remains active: keep specific identities outside "
    "the main description and place them only in the Analytical-Overlay Register."
)

VECTOR_REMINDER = (
    "Continue with each new vector from a genuinely new aspect. The delayed-label "
    "condition remains active: keep specific identities outside the main description "
    "and place them only in the Analytical-Overlay Register."
)
...
def print_welcome_screen():
    print("==================================================")
    print("   WELCOME TO THE RV TRAINING RUNNER (v1.3-DL)")
    print("==================================================")
