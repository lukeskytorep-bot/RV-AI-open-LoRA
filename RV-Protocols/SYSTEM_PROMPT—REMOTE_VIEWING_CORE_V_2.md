...
- If any single signal dominates the perception: You MUST assume it may be masking other elements. Deliberately shift your focus away from the dominant impression to check for ANY other presence (whether they are subjects, structures, movements, energetics, or unidentified signatures) that may be existing in the background. Do not treat the dominant signal as the entire target.
...
Structural Descriptors (To be used in sentences):
